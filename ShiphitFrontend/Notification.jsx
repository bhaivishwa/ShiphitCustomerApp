  ...
  return (
    <SafeAreaView style={{ flex: 1, position: "relative", }}>
      <ScrollView style={{ padding: 15 }}>
        ...
        <Image source={require("./assets/Sweet.png")} style={styles.signupimage}/>
        </View>
        <View style={styles.sweets}>
        <Text style={styles.paracontentone}>Lorem Ipsum is simply dummy text of
              the printing text of the text printing
        </Text>
